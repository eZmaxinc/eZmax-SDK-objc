...
[**taxassignmentGetAutocompleteV2**](EZObjectTaxassignmentApi.md#taxassignmentgetautocompletev2) | **GET** /2/object/taxassignment/getAutocomplete/{sSelector} | Retrieve Taxassignments and IDs
...
[apiInstance taxassignmentGetAutocompleteV2WithSSelector:sSelector
              ...
              sQuery:sQuery
              acceptLanguage:acceptLanguage
          completionHandler: ^(EZTaxassignmentGetAutocompleteV2Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling EZObjectTaxassignmentApi->taxassignmentGetAutocompleteV2: %@", error);
                        }
                    }];
```
...
[**EZTaxassignmentGetAutocompleteV2Response***](EZTaxassignmentGetAutocompleteV2Response.md)
