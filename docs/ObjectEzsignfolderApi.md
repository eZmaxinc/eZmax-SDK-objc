...
NSNumber* pkiEzsignfolderID = @56; // 
EzsignfolderDuplicateV1Request* ezsignfolderDuplicateV1Request = [[EzsignfolderDuplicateV1Request alloc] init]; // 

ObjectEzsignfolderApi*apiInstance = [[ObjectEzsignfolderApi alloc] init];

// Duplicate the Ezsignfolder
[apiInstance ezsignfolderDuplicateV1WithPkiEzsignfolderID:pkiEzsignfolderID
              ezsignfolderDuplicateV1Request:ezsignfolderDuplicateV1Request
          completionHandler: ^(EzsignfolderDuplicateV1Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderDuplicateV1: %@", error);
                        }
                    }];
```
...
NSNumber* pkiEzsignfolderID = @56; // 
NSString* eSignerType = @"eSignerType_example"; // 
NSNumber* fkiEzsignsignerID = @56; //  (optional)
NSNumber* fkiUserID = @56; //  (optional)

ObjectEzsignfolderApi*apiInstance = [[ObjectEzsignfolderApi alloc] init];

// Retrieve actionable elements of a user for the Ezsignfolder
[apiInstance ezsignfolderGetActionableElementsForSignerV1WithPkiEzsignfolderID:pkiEzsignfolderID
              eSignerType:eSignerType
              fkiEzsignsignerID:fkiEzsignsignerID
              fkiUserID:fkiUserID
          completionHandler: ^(EzsignfolderGetActionableElementsForSignerV1Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetActionableElementsForSignerV1: %@", error);
                        }
                    }];
```
...
------------- | ------------- | ------------- | -------------
 **pkiEzsignfolderID** | **NSNumber***|  | 
 **eSignerType** | **NSString***|  | 
 **fkiEzsignsignerID** | **NSNumber***|  | [optional] 
 **fkiUserID** | **NSNumber***|  | [optional] 
...
// Retrieve actionable elements for the Ezsignfolder
[apiInstance ezsignfolderGetActionableElementsV2WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetActionableElementsV2Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetActionableElementsV2: %@", error);
                        }
                    }];
```
...
// Retrieve actionable elements for the Ezsignfolder
[apiInstance ezsignfolderGetActionableElementsV3WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetActionableElementsV3Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetActionableElementsV3: %@", error);
                        }
                    }];
```
...
// Retrieve an existing Ezsignfolder's Ezsignannotations
[apiInstance ezsignfolderGetEzsignannotationsV1WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetEzsignannotationsV1Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetEzsignannotationsV1: %@", error);
                        }
                    }];
```
...
// Retrieve an existing Ezsignfolder's Ezsigndocuments
[apiInstance ezsignfolderGetEzsigndocumentsV2WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetEzsigndocumentsV2Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetEzsigndocumentsV2: %@", error);
                        }
                    }];
```
...
// Retrieve an existing Ezsignfolder's Ezsignfoldersignerassociations
[apiInstance ezsignfolderGetEzsignfoldersignerassociationsV2WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetEzsignfoldersignerassociationsV2Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetEzsignfoldersignerassociationsV2: %@", error);
                        }
                    }];
```
...
// Retrieve an existing Ezsignfolder's Ezsignformfieldgroups
[apiInstance ezsignfolderGetEzsignformfieldgroupsV1WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetEzsignformfieldgroupsV1Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetEzsignformfieldgroupsV1: %@", error);
                        }
                    }];
```
...
// Retrieve an existing Ezsignfolder's Ezsignsignatures
[apiInstance ezsignfolderGetEzsignsignaturesV1WithPkiEzsignfolderID:pkiEzsignfolderID
          completionHandler: ^(EzsignfolderGetEzsignsignaturesV1Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderGetEzsignsignaturesV1: %@", error);
                        }
                    }];
```
...
NSNumber* pkiEzsignfolderID = @56; // 
EzsignfolderImportEzsigntemplatepackageV2Request* ezsignfolderImportEzsigntemplatepackageV2Request = [[EzsignfolderImportEzsigntemplatepackageV2Request alloc] init]; // 

ObjectEzsignfolderApi*apiInstance = [[ObjectEzsignfolderApi alloc] init];

// Import an Ezsigntemplatepackage in the Ezsignfolder
[apiInstance ezsignfolderImportEzsigntemplatepackageV2WithPkiEzsignfolderID:pkiEzsignfolderID
              ezsignfolderImportEzsigntemplatepackageV2Request:ezsignfolderImportEzsigntemplatepackageV2Request
          completionHandler: ^(EzsignfolderImportEzsigntemplatepackageV2Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderImportEzsigntemplatepackageV2: %@", error);
                        }
                    }];
```
...
NSNumber* pkiEzsignfolderID = @56; // 
EzsignfolderImportEzsigntemplatepackageV3Request* ezsignfolderImportEzsigntemplatepackageV3Request = [[EzsignfolderImportEzsigntemplatepackageV3Request alloc] init]; // 

ObjectEzsignfolderApi*apiInstance = [[ObjectEzsignfolderApi alloc] init];

// Import an Ezsigntemplatepackage in the Ezsignfolder
[apiInstance ezsignfolderImportEzsigntemplatepackageV3WithPkiEzsignfolderID:pkiEzsignfolderID
              ezsignfolderImportEzsigntemplatepackageV3Request:ezsignfolderImportEzsigntemplatepackageV3Request
          completionHandler: ^(EzsignfolderImportEzsigntemplatepackageV3Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling ObjectEzsignfolderApi->ezsignfolderImportEzsigntemplatepackageV3: %@", error);
                        }
                    }];
```
