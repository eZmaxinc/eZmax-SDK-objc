...
------------ | ------------- | ------------- | -------------
**pkiEmployeeID** | **NSNumber*** | The unique ID of the Employee. | 
**fkiDepartmentID** | **NSNumber*** | The unique ID of the Department | 
**sEmployeeCode** | **NSString*** | The code of the Employee | 
**sEmployeeInternalcode** | **NSString*** | The internalcode of the Employee | 
**bEmployeeIsactive** | **NSNumber*** | Whether the employee is active or not | 
**dtEmployeeHiredate** | **NSString*** | The hiredate of the Employee | [optional] 
**dtEmployeeLeavedate** | **NSString*** | The leavedate of the Employee | [optional] 
