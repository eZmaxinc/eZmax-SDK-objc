...
**bUserAddmeinezsignfolder** | **NSNumber*** | Whether if I want to automatically add myself during the creation of Ezsignfolder of which I am the owner | 
...
**iUserFrontendgoal** | **NSNumber*** | Goals save as bit wise (one bit per goal) | 
