...
[**franchisebrokerGetAutocompleteV2**](EZObjectFranchisebrokerApi.md#franchisebrokergetautocompletev2) | **GET** /2/object/franchisebroker/getAutocomplete/{sSelector} | Retrieve Franchisebrokers and IDs
...
[apiInstance franchisebrokerGetAutocompleteV2WithSSelector:sSelector
              ...
              sQuery:sQuery
              acceptLanguage:acceptLanguage
          completionHandler: ^(EZFranchisebrokerGetAutocompleteV2Response* output, NSError* error) {
                        if (output) {
                            NSLog(@"%@", output);
                        }
                        if (error) {
                            NSLog(@"Error calling EZObjectFranchisebrokerApi->franchisebrokerGetAutocompleteV2: %@", error);
                        }
                    }];
```
...
[**EZFranchisebrokerGetAutocompleteV2Response***](EZFranchisebrokerGetAutocompleteV2Response.md)
