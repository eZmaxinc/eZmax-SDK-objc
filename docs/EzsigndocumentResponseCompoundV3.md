...
**bEzsigndocumentSendtoged** | **NSNumber*** | Whether the Ezsigndocument was copied to EDM | [optional] 
...
**iEzsigndocumentSteptotal** | **NSNumber*** | The total number of steps | 
**iEzsigndocumentStepcurrent** | **NSNumber*** | The current step | 
**aObjEzsignfoldersignerassociationstatus** | [**NSArray&lt;CustomEzsignfoldersignerassociationstatusResponseV3&gt;***](CustomEzsignfoldersignerassociationstatusResponseV3.md) |  | 
