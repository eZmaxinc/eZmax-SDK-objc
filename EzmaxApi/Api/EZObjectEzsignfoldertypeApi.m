...
///  @param pkiEzsignfoldertypeID  
///
///  @returns EZEzsignfoldertypeGetObjectV1Response*
///
-(NSURLSessionTask*) ezsignfoldertypeGetObjectV1WithPkiEzsignfoldertypeID: (NSNumber*) pkiEzsignfoldertypeID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsignfoldertypeGetObjectV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsignfoldertypeGetObjectV1Response*)data, error);
                                }
                            }];
}
