...
@interface ObjectEmailtypeApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectEmailtypeApi

NSString* kObjectEmailtypeApiErrorDomain = @"ObjectEmailtypeApiErrorDomain";
NSInteger kObjectEmailtypeApiMissingParamErrorCode = 234513;
...
///
///  @returns EmailtypeGetAutocompleteV2Response*
///
-(NSURLSessionTask*) emailtypeGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kObjectEmailtypeApiErrorDomain code:kObjectEmailtypeApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EmailtypeGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EmailtypeGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
