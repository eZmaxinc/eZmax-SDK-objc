...
@interface ObjectCreditcardclientApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectCreditcardclientApi

NSString* kObjectCreditcardclientApiErrorDomain = @"ObjectCreditcardclientApiErrorDomain";
NSInteger kObjectCreditcardclientApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) creditcardclientCreateObjectV1WithCreditcardclientCreateObjectV1Request: (CreditcardclientCreateObjectV1Request*) creditcardclientCreateObjectV1Request
    ...
    if (creditcardclientCreateObjectV1Request == nil) {
        NSParameterAssert(creditcardclientCreateObjectV1Request);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"creditcardclientCreateObjectV1Request"] };
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/creditcardclient"];
    ...
    bodyParam = creditcardclientCreateObjectV1Request;
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"CreditcardclientCreateObjectV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CreditcardclientCreateObjectV1Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) creditcardclientEditObjectV1WithPkiCreditcardclientID: (NSNumber*) pkiCreditcardclientID
    ...
    if (creditcardclientEditObjectV1Request == nil) {
        NSParameterAssert(creditcardclientEditObjectV1Request);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"creditcardclientEditObjectV1Request"] };
            NSError* error = [NSError errorWithDomain:kObjectCreditcardclientApiErrorDomain code:kObjectCreditcardclientApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = creditcardclientEditObjectV1Request;
...
-(NSURLSessionTask*) creditcardclientGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/creditcardclient/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CreditcardclientGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CreditcardclientGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) creditcardclientGetListV1WithEOrderBy: (NSString*) eOrderBy
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/creditcardclient/getList"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CreditcardclientGetListV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CreditcardclientGetListV1Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) creditcardclientGetObjectV2WithPkiCreditcardclientID: (NSNumber*) pkiCreditcardclientID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/creditcardclient/{pkiCreditcardclientID}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"CreditcardclientGetObjectV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
