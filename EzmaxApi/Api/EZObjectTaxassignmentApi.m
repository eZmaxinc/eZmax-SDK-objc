...
///  @param acceptLanguage  (optional)
///
///  @returns EZTaxassignmentGetAutocompleteV2Response*
///
-(NSURLSessionTask*) taxassignmentGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZTaxassignmentGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZTaxassignmentGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
