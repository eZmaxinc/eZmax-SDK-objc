...
///
///  @returns EZSecretquestionGetAutocompleteV2Response*
///
-(NSURLSessionTask*) secretquestionGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EZSecretquestionGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZSecretquestionGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
