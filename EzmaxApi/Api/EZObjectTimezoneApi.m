...
@interface EZObjectTimezoneApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation EZObjectTimezoneApi

NSString* kEZObjectTimezoneApiErrorDomain = @"EZObjectTimezoneApiErrorDomain";
NSInteger kEZObjectTimezoneApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) timezoneGetAutocompleteV1WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kEZObjectTimezoneApiErrorDomain code:kEZObjectTimezoneApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/timezone/getAutocomplete/{sSelector}"];
...
///  @param acceptLanguage  (optional)
///
///  @returns EZTimezoneGetAutocompleteV2Response*
///
-(NSURLSessionTask*) timezoneGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/timezone/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZTimezoneGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZTimezoneGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
