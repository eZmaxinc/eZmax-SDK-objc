...
///
///  @returns NotificationtestGetElementsV2Response*
///
-(NSURLSessionTask*) notificationtestGetElementsV2WithPkiNotificationtestID: (NSNumber*) pkiNotificationtestID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/notificationtest/{pkiNotificationtestID}/getElements"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NotificationtestGetElementsV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NotificationtestGetElementsV2Response*)data, error);
                                }
                            }];
}
