...
///  @param pkiEzsignbulksendsignermappingID  
///
///  @returns EZEzsignbulksendsignermappingGetObjectV1Response*
///
-(NSURLSessionTask*) ezsignbulksendsignermappingGetObjectV1WithPkiEzsignbulksendsignermappingID: (NSNumber*) pkiEzsignbulksendsignermappingID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsignbulksendsignermappingGetObjectV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsignbulksendsignermappingGetObjectV1Response*)data, error);
                                }
                            }];
}
