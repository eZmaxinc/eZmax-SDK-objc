...
///
///  @returns EZBillingentityinternalDeleteObjectV1Response*
///
-(NSURLSessionTask*) billingentityinternalDeleteObjectV1WithPkiBillingentityinternalID: (NSNumber*) pkiBillingentityinternalID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZBillingentityinternalDeleteObjectV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZBillingentityinternalDeleteObjectV1Response*)data, error);
                                }
                            }];
}
