...
-(NSURLSessionTask*) signatureGetObjectV3WithPkiSignatureID: (NSNumber*) pkiSignatureID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/3/object/signature/{pkiSignatureID}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SignatureGetObjectV3Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SignatureGetObjectV3Response*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) signatureGetSVGInitialsV1WithPkiSignatureID: (NSNumber*) pkiSignatureID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/signature/{pkiSignatureID}/getSVGInitials"];
...
-(NSURLSessionTask*) signatureGetSVGSignatureV1WithPkiSignatureID: (NSNumber*) pkiSignatureID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/signature/{pkiSignatureID}/getSVGSignature"];
