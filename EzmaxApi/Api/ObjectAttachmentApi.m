...
///  @param pkiAttachmentID  
///
///  @returns AttachmentGetDownloadUrlV1Response*
///
-(NSURLSessionTask*) attachmentGetDownloadUrlV1WithPkiAttachmentID: (NSNumber*) pkiAttachmentID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/attachment/{pkiAttachmentID}/getDownloadUrl"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AttachmentGetDownloadUrlV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AttachmentGetDownloadUrlV1Response*)data, error);
                                }
                            }];
}
