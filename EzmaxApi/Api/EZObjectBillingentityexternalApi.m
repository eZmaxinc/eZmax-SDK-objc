#import "EZObjectBillingentityexternalApi.h"
...
@interface EZObjectBillingentityexternalApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation EZObjectBillingentityexternalApi

NSString* kEZObjectBillingentityexternalApiErrorDomain = @"EZObjectBillingentityexternalApiErrorDomain";
NSInteger kEZObjectBillingentityexternalApiMissingParamErrorCode = 234513;
...
///
///  @returns EZBillingentityexternalGetAutocompleteV2Response*
///
-(NSURLSessionTask*) billingentityexternalGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kEZObjectBillingentityexternalApiErrorDomain code:kEZObjectBillingentityexternalApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EZBillingentityexternalGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZBillingentityexternalGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
