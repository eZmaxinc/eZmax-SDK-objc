#import "ObjectEzmaxproductApi.h"
...
@interface ObjectEzmaxproductApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectEzmaxproductApi

NSString* kObjectEzmaxproductApiErrorDomain = @"ObjectEzmaxproductApiErrorDomain";
NSInteger kObjectEzmaxproductApiMissingParamErrorCode = 234513;
...
///
///  @returns EzmaxproductGetAutocompleteV2Response*
///
-(NSURLSessionTask*) ezmaxproductGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kObjectEzmaxproductApiErrorDomain code:kObjectEzmaxproductApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EzmaxproductGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EzmaxproductGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
