...
#import "EzsignbulksenddocumentmappingGetObjectV3Response.h"
...
///  @param pkiEzsignbulksenddocumentmappingID  
///
///  @returns EzsignbulksenddocumentmappingGetObjectV3Response*
///
-(NSURLSessionTask*) ezsignbulksenddocumentmappingGetObjectV3WithPkiEzsignbulksenddocumentmappingID: (NSNumber*) pkiEzsignbulksenddocumentmappingID
    completionHandler: (void (^)(EzsignbulksenddocumentmappingGetObjectV3Response* output, NSError* error)) handler {
    // verify the required parameter 'pkiEzsignbulksenddocumentmappingID' is set
    if (pkiEzsignbulksenddocumentmappingID == nil) {
        NSParameterAssert(pkiEzsignbulksenddocumentmappingID);
        if(handler) {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EzsignbulksenddocumentmappingGetObjectV3Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EzsignbulksenddocumentmappingGetObjectV3Response*)data, error);
                                }
                            }];
}
