...
#import "EZEzsignfolderGetEzsignfoldersignerassociationsmineV1Response.h"
...
#import "EZEzsignfolderGetObjectV2Response.h"
...
#import "EZEzsignfolderSendV3Response.h"
...
///  @param pkiEzsignfolderID  
///
///  @returns EZEzsignfolderGetEzsignfoldersignerassociationsmineV1Response*
///
-(NSURLSessionTask*) ezsignfolderGetEzsignfoldersignerassociationsmineV1WithPkiEzsignfolderID: (NSNumber*) pkiEzsignfolderID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsignfolderGetEzsignfoldersignerassociationsmineV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsignfolderGetEzsignfoldersignerassociationsmineV1Response*)data, error);
                                }
                            }];
}
...
///  @param pkiEzsignfolderID  
///
///  @returns EZEzsignfolderGetObjectV2Response*
///
-(NSURLSessionTask*) ezsignfolderGetObjectV2WithPkiEzsignfolderID: (NSNumber*) pkiEzsignfolderID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsignfolderGetObjectV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsignfolderGetObjectV2Response*)data, error);
                                }
                            }];
}
...
///
///  @returns EZEzsignfolderSendV3Response*
///
-(NSURLSessionTask*) ezsignfolderSendV3WithPkiEzsignfolderID: (NSNumber*) pkiEzsignfolderID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsignfolderSendV3Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsignfolderSendV3Response*)data, error);
                                }
                            }];
}
