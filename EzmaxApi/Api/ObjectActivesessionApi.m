...
-(NSURLSessionTask*) activesessionGetCurrentV2WithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/activesession/getCurrent"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"ActivesessionGetCurrentV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ActivesessionGetCurrentV2Response*)data, error);
                                }
                            }];
}
