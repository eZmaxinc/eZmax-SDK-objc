...
@interface ObjectTimezoneApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectTimezoneApi

NSString* kObjectTimezoneApiErrorDomain = @"ObjectTimezoneApiErrorDomain";
NSInteger kObjectTimezoneApiMissingParamErrorCode = 234513;
...
///
///  @returns TimezoneGetAutocompleteV2Response*
///
-(NSURLSessionTask*) timezoneGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kObjectTimezoneApiErrorDomain code:kObjectTimezoneApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"TimezoneGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((TimezoneGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
