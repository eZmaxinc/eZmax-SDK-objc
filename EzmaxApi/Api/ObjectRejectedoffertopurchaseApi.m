...
-(NSURLSessionTask*) rejectedoffertopurchaseBatchDownloadV1WithPkiRejectedoffertopurchaseID: (NSNumber*) pkiRejectedoffertopurchaseID
    ...
    if (rejectedoffertopurchaseBatchDownloadV1Request == nil) {
        NSParameterAssert(rejectedoffertopurchaseBatchDownloadV1Request);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"rejectedoffertopurchaseBatchDownloadV1Request"] };
            NSError* error = [NSError errorWithDomain:kObjectRejectedoffertopurchaseApiErrorDomain code:kObjectRejectedoffertopurchaseApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/batchDownload"];
    ...
    bodyParam = rejectedoffertopurchaseBatchDownloadV1Request;
...
///  @param pkiRejectedoffertopurchaseID  
///
///  @returns RejectedoffertopurchaseGetAttachmentsV1Response*
///
-(NSURLSessionTask*) rejectedoffertopurchaseGetAttachmentsV1WithPkiRejectedoffertopurchaseID: (NSNumber*) pkiRejectedoffertopurchaseID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/rejectedoffertopurchase/{pkiRejectedoffertopurchaseID}/getAttachments"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"RejectedoffertopurchaseGetAttachmentsV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((RejectedoffertopurchaseGetAttachmentsV1Response*)data, error);
                                }
                            }];
}
