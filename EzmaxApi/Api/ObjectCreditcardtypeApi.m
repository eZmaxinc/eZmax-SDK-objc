#import "ObjectCreditcardtypeApi.h"
...
@interface ObjectCreditcardtypeApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectCreditcardtypeApi

NSString* kObjectCreditcardtypeApiErrorDomain = @"ObjectCreditcardtypeApiErrorDomain";
NSInteger kObjectCreditcardtypeApiMissingParamErrorCode = 234513;
...
///
///  @returns CreditcardtypeGetAutocompleteV2Response*
///
-(NSURLSessionTask*) creditcardtypeGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kObjectCreditcardtypeApiErrorDomain code:kObjectCreditcardtypeApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/creditcardtype/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"CreditcardtypeGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((CreditcardtypeGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
