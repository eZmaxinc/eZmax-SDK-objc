...
@interface EZObjectSessionhistoryApi: NSObject <EZApi>

extern NSString* kEZObjectSessionhistoryApiErrorDomain;
extern NSInteger kEZObjectSessionhistoryApiMissingParamErrorCode;
...
///
/// @return EZSessionhistoryGetListV1Response*
