...
@interface ObjectBrokerApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectBrokerApi

NSString* kObjectBrokerApiErrorDomain = @"ObjectBrokerApiErrorDomain";
NSInteger kObjectBrokerApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) brokerBatchDownloadV1WithPkiBrokerID: (NSNumber*) pkiBrokerID
    ...
    if (brokerBatchDownloadV1Request == nil) {
        NSParameterAssert(brokerBatchDownloadV1Request);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"brokerBatchDownloadV1Request"] };
            NSError* error = [NSError errorWithDomain:kObjectBrokerApiErrorDomain code:kObjectBrokerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/broker/{pkiBrokerID}/batchDownload"];
    ...
    bodyParam = brokerBatchDownloadV1Request;
...
///  @param pkiBrokerID  
///
///  @returns BrokerGetAttachmentsV1Response*
///
-(NSURLSessionTask*) brokerGetAttachmentsV1WithPkiBrokerID: (NSNumber*) pkiBrokerID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/broker/{pkiBrokerID}/getAttachments"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"BrokerGetAttachmentsV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((BrokerGetAttachmentsV1Response*)data, error);
                                }
                            }];
}
...
///
///  @returns BrokerGetAutocompleteV2Response*
///
-(NSURLSessionTask*) brokerGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/broker/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"BrokerGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
...
///
///  @returns BrokerGetListV1Response*
///
-(NSURLSessionTask*) brokerGetListV1WithEOrderBy: (NSString*) eOrderBy
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/broker/getList"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"BrokerGetListV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((BrokerGetListV1Response*)data, error);
                                }
                            }];
}
...
///
///  @returns BrokerImportIntoEDMV1Response*
///
-(NSURLSessionTask*) brokerImportIntoEDMV1WithPkiBrokerID: (NSNumber*) pkiBrokerID
    ...
    if (brokerImportIntoEDMV1Request == nil) {
        NSParameterAssert(brokerImportIntoEDMV1Request);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"brokerImportIntoEDMV1Request"] };
            NSError* error = [NSError errorWithDomain:kObjectBrokerApiErrorDomain code:kObjectBrokerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/broker/{pkiBrokerID}/importIntoEDM"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = brokerImportIntoEDMV1Request;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"BrokerImportIntoEDMV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((BrokerImportIntoEDMV1Response*)data, error);
                                }
                            }];
}
