...
@interface ObjectModuleApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectModuleApi

NSString* kObjectModuleApiErrorDomain = @"ObjectModuleApiErrorDomain";
NSInteger kObjectModuleApiMissingParamErrorCode = 234513;
...
///
///  @returns ModuleGetAutocompleteV2Response*
///
-(NSURLSessionTask*) moduleGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kObjectModuleApiErrorDomain code:kObjectModuleApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/module/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"ModuleGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((ModuleGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
