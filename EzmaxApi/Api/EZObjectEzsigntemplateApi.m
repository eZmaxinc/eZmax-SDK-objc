...
#import "EZEzsigntemplateGetObjectV2Response.h"
...
///  @param pkiEzsigntemplateID  
///
///  @returns EZEzsigntemplateGetObjectV2Response*
///
-(NSURLSessionTask*) ezsigntemplateGetObjectV2WithPkiEzsigntemplateID: (NSNumber*) pkiEzsigntemplateID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigntemplateGetObjectV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigntemplateGetObjectV2Response*)data, error);
                                }
                            }];
}
