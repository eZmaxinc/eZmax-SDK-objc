...
///
///  @returns EZEzsigndocumentDeclineToSignV1Response*
///
-(NSURLSessionTask*) ezsigndocumentDeclineToSignV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentDeclineToSignV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentDeclineToSignV1Response*)data, error);
                                }
                            }];
}
...
///  @param body  
///
///  @returns EZEzsigndocumentFlattenV1Response*
///
-(NSURLSessionTask*) ezsigndocumentFlattenV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentFlattenV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentFlattenV1Response*)data, error);
                                }
                            }];
}
...
///  @param pkiEzsigndocumentID  
///
///  @returns EZEzsigndocumentGetActionableElementsV1Response*
///
-(NSURLSessionTask*) ezsigndocumentGetActionableElementsV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentGetActionableElementsV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentGetActionableElementsV1Response*)data, error);
                                }
                            }];
}
...
///  @param pkiEzsigndocumentID  
///
///  @returns EZEzsigndocumentGetCompletedElementsV1Response*
///
-(NSURLSessionTask*) ezsigndocumentGetCompletedElementsV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentGetCompletedElementsV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentGetCompletedElementsV1Response*)data, error);
                                }
                            }];
}
...
///  @param pkiEzsigndocumentID  
///
///  @returns EZEzsigndocumentGetEzsignannotationsV1Response*
///
-(NSURLSessionTask*) ezsigndocumentGetEzsignannotationsV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentGetEzsignannotationsV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentGetEzsignannotationsV1Response*)data, error);
                                }
                            }];
}
...
///  @param pkiEzsigndocumentID  
///
///  @returns EZEzsigndocumentGetEzsignsignaturesAutomaticV1Response*
///
-(NSURLSessionTask*) ezsigndocumentGetEzsignsignaturesAutomaticV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentGetEzsignsignaturesAutomaticV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentGetEzsignsignaturesAutomaticV1Response*)data, error);
                                }
                            }];
}
...
///  @param pkiEzsigndocumentID  
///
///  @returns EZEzsigndocumentGetObjectV2Response*
///
-(NSURLSessionTask*) ezsigndocumentGetObjectV2WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentGetObjectV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentGetObjectV2Response*)data, error);
                                }
                            }];
}
...
///
///  @returns EZEzsigndocumentSubmitEzsignformV1Response*
///
-(NSURLSessionTask*) ezsigndocumentSubmitEzsignformV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentSubmitEzsignformV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentSubmitEzsignformV1Response*)data, error);
                                }
                            }];
}
...
///  @param body  
///
///  @returns EZEzsigndocumentUnsendV1Response*
///
-(NSURLSessionTask*) ezsigndocumentUnsendV1WithPkiEzsigndocumentID: (NSNumber*) pkiEzsigndocumentID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigndocumentUnsendV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigndocumentUnsendV1Response*)data, error);
                                }
                            }];
}
