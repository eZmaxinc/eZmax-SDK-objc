...
#import "DomainGetAutocompleteV2Response.h"
...
///
///  @returns DomainGetAutocompleteV2Response*
///
-(NSURLSessionTask*) domainGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/domain/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"DomainGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((DomainGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
