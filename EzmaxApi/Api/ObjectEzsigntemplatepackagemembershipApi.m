...
#import "EzsigntemplatepackagemembershipGetObjectV3Response.h"
...
///  @param pkiEzsigntemplatepackagemembershipID  
///
///  @returns EzsigntemplatepackagemembershipGetObjectV3Response*
///
-(NSURLSessionTask*) ezsigntemplatepackagemembershipGetObjectV3WithPkiEzsigntemplatepackagemembershipID: (NSNumber*) pkiEzsigntemplatepackagemembershipID
    completionHandler: (void (^)(EzsigntemplatepackagemembershipGetObjectV3Response* output, NSError* error)) handler {
    // verify the required parameter 'pkiEzsigntemplatepackagemembershipID' is set
    if (pkiEzsigntemplatepackagemembershipID == nil) {
        NSParameterAssert(pkiEzsigntemplatepackagemembershipID);
        if(handler) {
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/3/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EzsigntemplatepackagemembershipGetObjectV3Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EzsigntemplatepackagemembershipGetObjectV3Response*)data, error);
                                }
                            }];
}
