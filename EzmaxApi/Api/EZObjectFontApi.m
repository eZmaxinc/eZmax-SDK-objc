...
@interface EZObjectFontApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation EZObjectFontApi

NSString* kEZObjectFontApiErrorDomain = @"EZObjectFontApiErrorDomain";
NSInteger kEZObjectFontApiMissingParamErrorCode = 234513;
...
///
///  @returns EZFontGetAutocompleteV2Response*
///
-(NSURLSessionTask*) fontGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kEZObjectFontApiErrorDomain code:kEZObjectFontApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EZFontGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZFontGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
