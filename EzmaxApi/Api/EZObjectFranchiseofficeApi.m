#import "EZObjectFranchiseofficeApi.h"
...
@implementation EZObjectFranchiseofficeApi

NSString* kEZObjectFranchiseofficeApiErrorDomain = @"EZObjectFranchiseofficeApiErrorDomain";
NSInteger kEZObjectFranchiseofficeApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) franchiseofficeGetAutocompleteV1WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kEZObjectFranchiseofficeApiErrorDomain code:kEZObjectFranchiseofficeApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/franchiseoffice/getAutocomplete/{sSelector}"];
...
///  @param acceptLanguage  (optional)
///
///  @returns EZFranchiseofficeGetAutocompleteV2Response*
///
-(NSURLSessionTask*) franchiseofficeGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/2/object/franchiseoffice/getAutocomplete/{sSelector}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZFranchiseofficeGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZFranchiseofficeGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
