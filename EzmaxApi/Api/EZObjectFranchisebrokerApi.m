#import "EZObjectFranchisebrokerApi.h"
...
@interface EZObjectFranchisebrokerApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation EZObjectFranchisebrokerApi

NSString* kEZObjectFranchisebrokerApiErrorDomain = @"EZObjectFranchisebrokerApiErrorDomain";
NSInteger kEZObjectFranchisebrokerApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) franchisebrokerGetAutocompleteV1WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kEZObjectFranchisebrokerApiErrorDomain code:kEZObjectFranchisebrokerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/franchisebroker/getAutocomplete/{sSelector}"];
