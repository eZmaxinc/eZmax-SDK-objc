...
///  @param pkiEzsignbulksendtransmissionID  
///
///  @returns EZEzsignbulksendtransmissionGetObjectV1Response*
///
-(NSURLSessionTask*) ezsignbulksendtransmissionGetObjectV1WithPkiEzsignbulksendtransmissionID: (NSNumber*) pkiEzsignbulksendtransmissionID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsignbulksendtransmissionGetObjectV1Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
