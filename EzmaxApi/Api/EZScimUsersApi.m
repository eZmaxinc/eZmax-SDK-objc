...
@interface EZScimUsersApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation EZScimUsersApi

NSString* kEZScimUsersApiErrorDomain = @"EZScimUsersApiErrorDomain";
NSInteger kEZScimUsersApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) usersCreateObjectScimV2WithScimUser: (EZScimUser*) scimUser
    ...
    if (scimUser == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kEZScimUsersApiErrorDomain code:kEZScimUsersApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EZScimUser*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZScimUser*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) usersGetListScimV2WithFilter: (NSString*) filter
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZScimUserList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZScimUserList*)data, error);
                                }
                            }];
}
