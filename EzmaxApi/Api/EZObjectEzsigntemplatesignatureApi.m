...
///  @param pkiEzsigntemplatesignatureID  
///
///  @returns EZEzsigntemplatesignatureGetObjectV2Response*
///
-(NSURLSessionTask*) ezsigntemplatesignatureGetObjectV2WithPkiEzsigntemplatesignatureID: (NSNumber*) pkiEzsigntemplatesignatureID
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"EZEzsigntemplatesignatureGetObjectV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EZEzsigntemplatesignatureGetObjectV2Response*)data, error);
                                }
                            }];
}
