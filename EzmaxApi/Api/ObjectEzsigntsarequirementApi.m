#import "ObjectEzsigntsarequirementApi.h"
...
@interface ObjectEzsigntsarequirementApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation ObjectEzsigntsarequirementApi

NSString* kObjectEzsigntsarequirementApiErrorDomain = @"ObjectEzsigntsarequirementApiErrorDomain";
NSInteger kObjectEzsigntsarequirementApiMissingParamErrorCode = 234513;
...
///
///  @returns EzsigntsarequirementGetAutocompleteV2Response*
///
-(NSURLSessionTask*) ezsigntsarequirementGetAutocompleteV2WithSSelector: (NSString*) sSelector
    ...
    if (sSelector == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kObjectEzsigntsarequirementApiErrorDomain code:kObjectEzsigntsarequirementApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"EzsigntsarequirementGetAutocompleteV2Response*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((EzsigntsarequirementGetAutocompleteV2Response*)data, error);
                                }
                            }];
}
