...
@protocol FieldEEzsigntemplatesignerRole;
...
@interface EzsigntemplatesignerResponseCompoundV3 : Object
...
@property(nonatomic) FieldEEzsigntemplatesignerRole* eEzsigntemplatesignerRole;
