...
@protocol FieldEEzsignfoldertypeDocumentmerge;
...
@interface EzsignfoldertypeRequestCompoundV4 : Object
...
@property(nonatomic) NSArray<NSNumber*>* aFkiUserlogintypeID;

@property(nonatomic) NSArray<NSNumber*>* aFkiUsergroupIDAll;

@property(nonatomic) NSArray<NSNumber*>* aFkiUsergroupIDRestricted;

@property(nonatomic) NSArray<NSNumber*>* aFkiUsergroupIDTemplate;
...
@property(nonatomic) FieldEEzsignfoldertypeDocumentmerge* eEzsignfoldertypeDocumentmerge;
...
/* Whether we send the attachments contained in the Ezsignsignatures in the email to Ezsignsigner [optional]
 */
@property(nonatomic) NSNumber* bEzsignfoldertypeSendsignatureattachmentezsignsigner;
/* Whether we send the attachments contained in the Ezsignsignatures in the email to external recipient [optional]
 */
@property(nonatomic) NSNumber* bEzsignfoldertypeSendsignatureattachment;
...
/* Whether we send the attachments contained in the Ezsignsignatures in the email to User [optional]
 */
@property(nonatomic) NSNumber* bEzsignfoldertypeSendsignatureattachmentuser;
...
/* Whether we allow the attachments in the Ezsignsignatures to be downloaded by an Ezsignsigner [optional]
 */
@property(nonatomic) NSNumber* bEzsignfoldertypeAllowdownloadsignatureattachmentezsignsigner;
...
/* Whether we send the attachments contained in the Ezsignsignatures to user and Ezsignsigner who receive all documents. [optional]
 */
@property(nonatomic) NSNumber* bEzsignfoldertypeSendsignatureattachmentreceivealldocument;
