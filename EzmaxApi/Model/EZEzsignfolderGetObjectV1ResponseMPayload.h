...
@class EZCommonAudit;
@protocol EZCustomEzsignfoldertypeResponse;
@class EZCustomEzsignfoldertypeResponse;
...
@property(nonatomic) EZCustomEzsignfoldertypeResponse* objEzsignfoldertype;
