...
@protocol EZUserRequestCompound
@end

@interface EZUserRequestCompound : EZObject
...
@property(nonatomic) EZEmailRequestCompound* objEmail;
/* The unique ID of the Billingentityinternal. 
 */
@property(nonatomic) NSNumber* fkiBillingentityinternalID;

@property(nonatomic) EZPhoneRequestCompound* objPhoneHome;

@property(nonatomic) EZPhoneRequestCompound* objPhoneSMS;
