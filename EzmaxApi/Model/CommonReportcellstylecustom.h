...
@interface CommonReportcellstylecustom : Object

/* Whether there is a border at the top of the Reportcell [optional]
 */
@property(nonatomic) NSNumber* bReportcellstyleBordertop;
/* Whether there is a border at the bottom of the Reportcell [optional]
 */
@property(nonatomic) NSNumber* bReportcellstyleBorderbottom;
/* Whether there is a border at the left of the Reportcell [optional]
 */
@property(nonatomic) NSNumber* bReportcellstyleBorderleft;
/* Whether there is a border at the right of the Reportcell [optional]
 */
