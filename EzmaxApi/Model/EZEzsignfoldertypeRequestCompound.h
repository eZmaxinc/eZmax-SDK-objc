...
@protocol EZEzsignfoldertypeRequest;
@class EZEzsignfoldertypeRequest;
@protocol EZEzsignfoldertypeRequestCompoundAllOf;
@class EZEzsignfoldertypeRequestCompoundAllOf;
...
@interface EZEzsignfoldertypeRequestCompound : EZObject
