...
/* Whether is the system allows to have a complex creditcard signature [optional]
 */
@property(nonatomic) NSNumber* bSystemconfigurationAllowcomplexcreditcardsignature;
