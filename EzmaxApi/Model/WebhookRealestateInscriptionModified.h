...
@protocol WebhookRealestateInscriptionModified
@end

@interface WebhookRealestateInscriptionModified : Object
...
@property(nonatomic) InscriptionResponse* objEzmaxpartnerproduct;
