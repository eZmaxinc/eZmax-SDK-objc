...
@protocol BuyercontractGetListV1ResponseMPayload;
...
@protocol BuyercontractGetListV1Response
@end

@interface BuyercontractGetListV1Response : Object
...
@property(nonatomic) BuyercontractGetListV1ResponseMPayload* mPayload;
