...
@class CommonAudit;
@protocol CustomEzsignfoldersignerassociationstatusResponseV3;
...
@interface EzsigndocumentResponseCompoundV3 : Object
...
/* Whether the Ezsigndocument was copied to EDM [optional]
 */
@property(nonatomic) NSNumber* bEzsigndocumentSendtoged;
 ...
 */
@property(nonatomic) NSNumber* iEzsigndocumentSteptotal;
/* The current step 
 */
@property(nonatomic) NSNumber* iEzsigndocumentStepcurrent;

@property(nonatomic) NSArray<CustomEzsignfoldersignerassociationstatusResponseV3>* aObjEzsignfoldersignerassociationstatus;
