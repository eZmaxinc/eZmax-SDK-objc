...
@protocol EZEzsigntemplatesignaturecustomdateResponse;
@class EZEzsigntemplatesignaturecustomdateResponse;
...
@interface EZEzsigntemplatesignaturecustomdateResponseCompound : EZObject
