...
@protocol AgentGetListV1ResponseMPayload;
...
@protocol AgentGetListV1Response
@end

@interface AgentGetListV1Response : Object
...
@property(nonatomic) AgentGetListV1ResponseMPayload* mPayload;
