#import "EzsigntemplatesignaturecustomdateResponseCompound.h"

@implementation EzsigntemplatesignaturecustomdateResponseCompound
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"iEzsigntemplatesignaturecustomdateX", @"iEzsigntemplatesignaturecustomdateY", @"iEzsigntemplatesignaturecustomdateOffsetx", @"iEzsigntemplatesignaturecustomdateOffsety", ];
