...
@interface EZEzsignbulksendtransmissionGetObjectV2ResponseMPayload : EZObject


@property(nonatomic) EZEzsignbulksendtransmissionResponseCompound* objEzsignbulksendtransmission;
