#import "CustomerRequestCompound.h"

@implementation CustomerRequestCompound
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiCustomerID", @"sCustomerNote", @"efkiUserID", @"efksCustomerCode", @"iMPORTID"];
