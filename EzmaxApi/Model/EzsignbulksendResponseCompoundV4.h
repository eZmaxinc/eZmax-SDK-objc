...
@class EzsignbulksendsignermappingResponseV3;
@protocol FieldEEzsignbulksendEzsignformfieldorder;
...
@protocol EzsignbulksendResponseCompoundV4
@end

@interface EzsignbulksendResponseCompoundV4 : Object
...
@property(nonatomic) FieldEEzsignbulksendEzsignformfieldorder* eEzsignbulksendEzsignformfieldorder;
...
@property(nonatomic) NSArray<EzsignbulksenddocumentmappingResponseCompoundV3>* aObjEzsignbulksenddocumentmapping;

@property(nonatomic) NSArray<EzsignbulksendsignermappingResponseV3>* aObjEzsignbulksendsignermapping;
