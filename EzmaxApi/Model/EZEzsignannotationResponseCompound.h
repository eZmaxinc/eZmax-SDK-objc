...
@class EZTextstylestaticResponseCompound;
...
@interface EZEzsignannotationResponseCompound : EZObject
...
@property(nonatomic) EZTextstylestaticResponseCompound* objTextstylestatic;
