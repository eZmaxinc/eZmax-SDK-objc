#import "UserListElement.h"

@implementation UserListElement
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"fkiAgentID", @"fkiBrokerID", @"bUserSuspended", @"dtUserEzsignprepaidexpiration", @"sUserJobtitle"];
