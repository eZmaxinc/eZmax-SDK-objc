...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"fkiUserID", @"fkiUsergroupexternalID", @"sUserFirstname", @"sUserLastname", @"sUserLoginname", @"sEmailAddress", @"bUserIsactive", @"sUsergroupexternalName"];
