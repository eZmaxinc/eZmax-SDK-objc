...
@protocol CreditcardclientGetListV1Response
@end

@interface CreditcardclientGetListV1Response : CommonResponseGetList


@property(nonatomic) CreditcardclientGetListV1ResponseMPayload* mPayload;
