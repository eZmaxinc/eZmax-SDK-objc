...
@class CommonAudit;
@protocol CommunicationattachmentResponseCompound;
@class CommunicationattachmentResponseCompound;
@protocol CommunicationexternalrecipientResponseCompound;
@class CommunicationexternalrecipientResponseCompound;
@protocol CommunicationrecipientResponseCompound;
...
@protocol CommunicationResponseCompound
@end

@interface CommunicationResponseCompound : Object
...
@property(nonatomic) NSArray<CommunicationattachmentResponseCompound>* aObjCommunicationattachment;

@property(nonatomic) NSArray<CommunicationrecipientResponseCompound>* aObjCommunicationrecipient;

@property(nonatomic) NSArray<CommunicationexternalrecipientResponseCompound>* aObjCommunicationexternalrecipient;
