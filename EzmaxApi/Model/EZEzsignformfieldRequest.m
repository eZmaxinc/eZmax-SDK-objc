#import "EZEzsignformfieldRequest.h"

@implementation EZEzsignformfieldRequest
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzsignformfieldID", @"sEzsignformfieldValue", @"bEzsignformfieldSelected", @"sEzsignformfieldEnteredvalue"];
