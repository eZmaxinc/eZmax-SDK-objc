...
@protocol SupplierGetListV1ResponseMPayload;
@class SupplierGetListV1ResponseMPayload;



@protocol SupplierGetListV1Response
@end

@interface SupplierGetListV1Response : Object
...
@property(nonatomic) SupplierGetListV1ResponseMPayload* mPayload;
