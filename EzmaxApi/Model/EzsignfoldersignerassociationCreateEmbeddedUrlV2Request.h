...
@protocol EzsignfoldersignerassociationCreateEmbeddedUrlV2Request
@end

@interface EzsignfoldersignerassociationCreateEmbeddedUrlV2Request : Object
...
/* This is used to fill the header frame ancestor to allow the application to embed the Ezsign signature page [optional]
 */
@property(nonatomic) NSString* sIframeOrigin;
