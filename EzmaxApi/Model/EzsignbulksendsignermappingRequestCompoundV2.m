...
@implementation EzsignbulksendsignermappingRequestCompoundV2
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzsignbulksendsignermappingID", @"fkiUserID", @"eEzsignbulksendsignermappingRole", ];
