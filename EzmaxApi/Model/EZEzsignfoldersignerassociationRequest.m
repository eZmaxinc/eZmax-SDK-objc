...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzsignfoldersignerassociationID", @"fkiUserID", @"fkiUsergroupID", @"fkiEzsignsignergroupID", @"bEzsignfoldersignerassociationReceivecopy", @"tEzsignfoldersignerassociationMessage"];
