...
@protocol SessionhistoryGetListV1Response
@end

@interface SessionhistoryGetListV1Response : CommonResponseGetList


@property(nonatomic) SessionhistoryGetListV1ResponseMPayload* mPayload;
