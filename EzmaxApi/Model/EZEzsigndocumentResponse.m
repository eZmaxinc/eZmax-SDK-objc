...
@implementation EZEzsigndocumentResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"fkiEzsignfoldersignerassociationIDDeclinedtosign", @"dtEzsignformCompleted", @"dtEzsigndocumentFirstsend", @"dtEzsigndocumentLastsend", @"tEzsigndocumentDeclinedtosignreason", ];
