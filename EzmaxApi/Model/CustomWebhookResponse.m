...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiWebhookID", @"fkiAuthenticationexternalID", @"fkiEzsignfoldertypeID", @"sEzsignfoldertypeNameX", @"eWebhookEzmaxpartnerevent", @"eWebhookEzsignevent", @"eWebhookManagementevent", @"eWebhookRealestateevent", @"sWebhookApikey", @"sWebhookSecret", @"sAuthenticationexternalDescription", @"objAudit", @"sWebhookEvent", @"sWebhookAuthentificationexternalerror", @"aObjWebhookheader", @"eWebhookEmittype", @"fkiEzmaxpartnerproductstagewebhookID"];
