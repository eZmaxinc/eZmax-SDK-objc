#import "InscriptionResponse.h"

@implementation InscriptionResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"sCompanyNameX", @"sDepartmentNameX", @"sRealestateboardNameX", @"sAddress", @"sInscriptionbuildingtypeNameX", @"sInscriptiontypeNameX", @"sInscriptioncategoryNameX", ];
