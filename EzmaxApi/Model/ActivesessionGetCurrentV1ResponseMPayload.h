...
@interface ActivesessionGetCurrentV1ResponseMPayload : Object
...
/* The date at which the NPS questionnaire will be show [optional]
 */
@property(nonatomic) NSString* dtUserNpsrequest;
