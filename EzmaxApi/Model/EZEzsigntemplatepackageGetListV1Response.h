...
@protocol EZEzsigntemplatepackageGetListV1ResponseAllOf;
@class EZEzsigntemplatepackageGetListV1ResponseAllOf;
@protocol EZEzsigntemplatepackageGetListV1ResponseMPayload;
@class EZEzsigntemplatepackageGetListV1ResponseMPayload;



@protocol EZEzsigntemplatepackageGetListV1Response
@end

@interface EZEzsigntemplatepackageGetListV1Response : EZObject


@property(nonatomic) EZEzsigntemplatepackageGetListV1ResponseMPayload* mPayload;
