...
@protocol EZEzsignsignatureCreateObjectV1Request
@end

@interface EZEzsignsignatureCreateObjectV1Request : EZObject


@property(nonatomic) EZEzsignsignatureRequest* objEzsignsignature;

@property(nonatomic) EZEzsignsignatureRequestCompound* objEzsignsignatureCompound;
