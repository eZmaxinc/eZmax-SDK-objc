...
@class EZCommonAudit;
@protocol EZEmailResponseCompound;
@class EZEmailResponseCompound;
@protocol EZFieldEUserEzsignaccess;
@class EZFieldEUserEzsignaccess;
@protocol EZFieldEUserLogintype;
@class EZFieldEUserLogintype;
...
@property(nonatomic) EZEmailResponseCompound* objEmail;
...
@property(nonatomic) EZPhoneResponseCompound* objPhoneHome;
...
@property(nonatomic) EZFieldEUserLogintype* eUserLogintype;
