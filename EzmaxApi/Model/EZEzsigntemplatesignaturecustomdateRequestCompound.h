...
@protocol EZEzsigntemplatesignaturecustomdateRequest;
@class EZEzsigntemplatesignaturecustomdateRequest;
...
@interface EZEzsigntemplatesignaturecustomdateRequestCompound : EZObject
