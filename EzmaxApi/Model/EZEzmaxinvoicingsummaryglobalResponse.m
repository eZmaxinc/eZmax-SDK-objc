...
@implementation EZEzmaxinvoicingsummaryglobalResponse
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzmaxinvoicingsummaryglobalID", @"fkiEzmaxinvoicingID", @"dEzmaxinvoicingsummaryglobalRepresentative", @"dEzmaxinvoicingsummaryglobalPartner", @"dEzmaxinvoicingsummaryglobalNet", ];
