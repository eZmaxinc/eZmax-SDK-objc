...
@interface EzsigntemplatepackagesignerGetObjectV2ResponseMPayload : Object


@property(nonatomic) EzsigntemplatepackagesignerResponseCompound* objEzsigntemplatepackagesigner;
