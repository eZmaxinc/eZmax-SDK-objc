...
@implementation EZEzsigntemplateformfieldRequest
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzsigntemplateformfieldID", @"sEzsigntemplateformfieldValue", @"bEzsigntemplateformfieldSelected"];
