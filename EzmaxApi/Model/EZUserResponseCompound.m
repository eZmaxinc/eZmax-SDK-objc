...
@implementation EZUserResponseCompound
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"fkiAgentID", @"fkiBrokerID", @"fkiAssistantID", @"fkiEmployeeID", @"objPhoneHome", @"objPhoneSMS", @"fkiSecretquestionID", @"fkiModuleIDForm", @"sModuleNameX", @"dtUserLastlogondate", @"dtUserPasswordchanged", @"dtUserEzsignprepaidexpiration", @"bUserValidatebyadministration", @"bUserValidatebydirector", @"bUserAttachmentautoverified", ];
