...
@implementation ActivesessionGetCurrentV1ResponseMPayload
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"bActivesessionAttachment", @"bActivesessionCanafe", @"bActivesessionFinancial", @"bActivesessionRealestatecompleted", @"eActivesessionEzsign", @"eActivesessionEzsignprepaid", @"eActivesessionRealestateinprogress", @"fkiSignatureID", @"fkiEzsignuserID", @"bSystemconfigurationEzsignpaidbyoffice", @"eSystemconfigurationEzsignofficeplan", @"eUserEzsignprepaid", @"bUserEzsigntrial", @"bUserEzsigntemplaterolegrouping", @"dtUserEzsignprepaidexpiration", @"dtUserNpsrequest", @"objUserCloned", @"objApikey", @"bActivesessionMaillinglistrequest"];
