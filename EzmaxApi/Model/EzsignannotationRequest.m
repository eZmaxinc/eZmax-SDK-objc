...
@implementation EzsignannotationRequest
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzsignannotationID", @"eEzsignannotationHorizontalalignment", @"eEzsignannotationVerticalalignment", @"iEzsignannotationWidth", @"iEzsignannotationHeight", @"sEzsignannotationText", ];
