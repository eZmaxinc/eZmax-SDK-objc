...
@interface CustomEzsignfoldertransmissionResponse : Object
...
@property(nonatomic) NSArray<CustomEzsignfoldertransmissionSignerResponse>* aObjEzsignfoldertransmissionSigner;
