...
@interface EzsignformfieldgroupResponse : Object
...
/* The date the Ezsignformfieldgroup was completed. [optional]
 */
@property(nonatomic) NSString* dtEzsignformfieldgroupCompleted;
