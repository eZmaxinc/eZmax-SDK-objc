...
@implementation EzsigntemplatesignerRequestCompoundV2
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiEzsigntemplatesignerID", @"fkiUserID", @"fkiUsergroupID", @"fkiEzdoctemplatedocumentID", @"eEzsigntemplatesignerRole", @"eEzsigntemplatesignerMapping", ];
