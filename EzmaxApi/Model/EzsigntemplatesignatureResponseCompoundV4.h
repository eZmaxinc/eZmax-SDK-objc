...
@protocol EzsigntemplateelementdependencyResponseCompound;
@class EzsigntemplateelementdependencyResponseCompound;
@protocol EzsigntemplatesignaturecustomdateResponseCompoundV2;
...
@protocol EzsigntemplatesignatureResponseCompoundV4
@end

@interface EzsigntemplatesignatureResponseCompoundV4 : Object
 ...
 */
@property(nonatomic) NSString* sEzsigntemplatesignatureCreditcardamountdescription;
/* The amount of the Creditcard signature [optional]
 */
@property(nonatomic) NSString* dEzsigntemplatesignatureCreditcardamount;
 ...
 */
@property(nonatomic) NSArray<EzsigntemplatesignaturecustomdateResponseCompoundV2>* aObjEzsigntemplatesignaturecustomdate;

@property(nonatomic) NSArray<EzsigntemplateelementdependencyResponseCompound>* aObjEzsigntemplateelementdependency;

@property(nonatomic) NSArray<EzsigntemplatesignaturepaymentdetailResponseCompound>* aObjEzsigntemplatesignaturepaymentdetail;
