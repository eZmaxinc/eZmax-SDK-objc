...
@protocol WebhookRealestateInscriptionnotauthenticatedModified
@end

@interface WebhookRealestateInscriptionnotauthenticatedModified : Object
...
@property(nonatomic) InscriptionnotauthenticatedResponse* objInscriptionnotauthenticated;
