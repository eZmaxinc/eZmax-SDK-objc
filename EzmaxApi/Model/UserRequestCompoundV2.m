...
@implementation UserRequestCompoundV2
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"pkiUserID", @"fkiAgentID", @"fkiBrokerID", @"fkiAssistantID", @"fkiEmployeeID", @"objPhoneHome", @"objPhoneSMS", @"fkiSecretquestionID", @"sUserSecretresponse", @"fkiModuleIDForm", @"sUserJobtitle", @"bUserValidatebyadministration", @"bUserValidatebydirector", @"bUserAttachmentautoverified", @"bUserChangepassword", @"bUserEzsigntemplaterolegrouping"];
