...
@protocol EzsignsigningreasonGetListV1Response
@end

@interface EzsignsigningreasonGetListV1Response : CommonResponseGetList


@property(nonatomic) EzsignsigningreasonGetListV1ResponseMPayload* mPayload;
