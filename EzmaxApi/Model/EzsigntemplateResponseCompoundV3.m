...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"fkiEzsigntemplatedocumentID", @"fkiEzsignfoldertypeID", @"fkiEzdoctemplatedocumentID", @"sEzdoctemplatedocumentNameX", @"sEzsigntemplateExternaldescription", @"tEzsigntemplateComment", @"eEzsigntemplateRecognition", @"sEzsigntemplateFilenameregexp", @"sEzsignfoldertypeNameX", @"eEzsigntemplateType", @"objEzsigntemplatedocument", ];
