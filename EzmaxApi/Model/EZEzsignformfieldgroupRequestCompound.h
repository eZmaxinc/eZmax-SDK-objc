...
@protocol EZEzsignformfieldgroupRequest;
@class EZEzsignformfieldgroupRequest;
@protocol EZEzsignformfieldgroupRequestCompoundAllOf;
@class EZEzsignformfieldgroupRequestCompoundAllOf;
...
@interface EZEzsignformfieldgroupRequestCompound : EZObject
