...
@protocol WebhookRealestateBuyercontractModified
@end

@interface WebhookRealestateBuyercontractModified : Object
...
@property(nonatomic) BuyercontractResponse* objBuyercontract;
