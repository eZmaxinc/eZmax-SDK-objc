...
@protocol VariableexpenseGetListV1Response
@end

@interface VariableexpenseGetListV1Response : CommonResponseGetList


@property(nonatomic) VariableexpenseGetListV1ResponseMPayload* mPayload;
