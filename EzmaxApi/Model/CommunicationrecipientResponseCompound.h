...
@protocol FieldECommunicationrecipientObjecttype;
...
@interface CommunicationrecipientResponseCompound : Object

/* The unique ID of the Communicationrecipient. 
 */
@property(nonatomic) NSNumber* pkiCommunicationrecipientID;

@property(nonatomic) FieldECommunicationrecipientObjecttype* eCommunicationrecipientObjecttype;
