...
@protocol UserstagedGetListV1Response
@end

@interface UserstagedGetListV1Response : CommonResponseGetList


@property(nonatomic) UserstagedGetListV1ResponseMPayload* mPayload;
