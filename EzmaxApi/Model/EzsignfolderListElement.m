...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"dtEzsignfolderDelayedsenddate", @"dtEzsignfolderSentdate", @"dtEzsignfolderDuedate", @"bEzsignformHasdependencies", @"dtEzsignfolderClose", @"dtEzsignfolderArchive", @"dtEzsignfolderDispose", @"bEzsignfolderSigner"];
