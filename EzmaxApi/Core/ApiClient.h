 ...
 */
extern NSString *const ResponseObjectErrorKey;


@interface ApiClient : AFHTTPSessionManager

@property (nonatomic, strong, readonly) id<Configuration> configuration;

@property(nonatomic, assign) NSTimeInterval timeoutInterval;

@property(nonatomic, strong) id<ResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<Sanitizer> sanitizer;
