...
NSString *const EZDeserializationErrorDomainKey = @"EZDeserializationErrorDomainKey";

NSInteger const EZTypeMismatchErrorCode = 143553;

NSInteger const EZEmptyValueOccurredErrorCode = 143509;

NSInteger const EZUnknownResponseObjectErrorCode = 143528;


@interface EZResponseDeserializer ()
...
@implementation EZResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:EZDeserializationErrorDomainKey code:EZTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:EZDeserializationErrorDomainKey code:EZEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:EZDeserializationErrorDomainKey code:EZUnknownResponseObjectErrorCode userInfo:userInfo];
}
