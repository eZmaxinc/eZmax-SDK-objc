...
NSString * const kEZApplicationJSONType = @"application/json";

NSString * EZPercentEscapedStringFromString(NSString *string) {
    static NSString * const kEZCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kEZCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kEZCharactersGeneralDelimitersToEncode stringByAppendingString:kEZCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[EZQueryParamCollection class]]) {
        return object;
    }
    else if ([object isKindOfClass:[NSDate class]]) {
        return [EZSanitizer dateToString:object];
    }
    ...
    else if ([object isKindOfClass:[EZObject class]]) {
...
- (NSString *) parameterToString:(id)param {
    if ([param isKindOfClass:[NSString class]]) {
        ...
        return [EZSanitizer dateToString:param];
    }
...
+ (NSString *)dateToString:(id)date {
    NSTimeZone* timeZone = [EZDefaultConfiguration sharedConfig].serializationTimeZone;
