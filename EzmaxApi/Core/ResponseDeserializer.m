...
NSString *const DeserializationErrorDomainKey = @"DeserializationErrorDomainKey";

NSInteger const TypeMismatchErrorCode = 143553;

NSInteger const EmptyValueOccurredErrorCode = 143509;

NSInteger const UnknownResponseObjectErrorCode = 143528;
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:DeserializationErrorDomainKey code:TypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DeserializationErrorDomainKey code:EmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:DeserializationErrorDomainKey code:UnknownResponseObjectErrorCode userInfo:userInfo];
}
