...
#import "EZBasicAuthTokenProvider.h"
#import "EZLogger.h"

@interface EZDefaultConfiguration ()
...
@implementation EZDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static EZDefaultConfiguration *shardConfig = nil;
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [EZBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
